...
public class ArticleListAdminTaglib extends TagSupport {
	...
	public int doEndTag() throws JspException {
		...
		try 
		{
			...
			for(int i = 0;i<list.size();i++)
			{
	        	...
	        	out.println("<div class=\"title\">标题："+article.getTitle()+"</div>");
	        	out.println("<div class=\"func1\"><a href=\"edit_Article.jsp?article_id="+article.getId()+"\">[编辑]</a>" +"&nbsp;<a href=\"delete_Article.jsp?article_id="+article.getId()+" \"onclick=\"{if(confirm(\'确定删除该新闻？\')){return true;}return false;}\">[删除]</a></div></div>");
